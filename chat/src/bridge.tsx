 ...
 * (CustomEvent)로 간다: 뷰 번들(npm @relay/chat)과 위젯 번들(/assets/chat-app.js)은
 ...
 * "@relay/chat/bridge" 서브패스로 연다(§2-5) — 루트는 뷰 앱의 표면이다.
 *
 ...
 *  (index.js)에는 재수출하지 않고, 크롬은 "@relay/chat/bridge" 서브패스로 받는다.
