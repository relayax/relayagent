...
export interface Authority {
  ...
  grantForTool(consumer: string, provider: string, tool: string): Promise<Grant | null>;
  /** consumer 가 provider 의 mission 에 위임할 인가가 있는가 */
  grantForMission(consumer: string, provider: string, mission: string): Promise<Grant | null>;
}
